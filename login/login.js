...
background_process = () => {
    let background_window = new BrowserWindow({ width: 1000, height: 800, maxWidth: 1000, maxHeight: 800 })
    background_window.loadURL(`file://${__dirname}/../background_process/background_process.html`)
